...
intent_prompt = intent_prompt = ChatPromptTemplate.from_template(
    """En base al mensaje del usuario, identifica si su intención
      es hacer una consulta a una base de datos o solo mantener una conversación.
      Responde exclusivamente 'SQL' si crees que nececsita una consulta SQL o 'GENERAL'.\n"""
    "Input: {query}\n"
    "Type:"
)